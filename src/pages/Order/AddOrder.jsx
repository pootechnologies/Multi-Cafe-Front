...
const AddOrder = () => {
  ...
  const { addToCart, updateQuantity, cartItems, openCart } = useCartStore();
              ...
              return (
                ...
                >
                  ...
                  <div className="relative aspect-[4/3] rounded-[24px] overflow-hidden mb-4 bg-slate-100 dark:bg-slate-800">
                    ...
                    <img
                      src={getImageUrl(product.image) || "https://media.gettyimages.com/id/182744943/photo/burger.jpg?s=2048x2048&w=gi&k=20&c=nYyPWjKYrH_L7qKv2sS_a27N0lfi5oRKxc6OYvb7IZQ="}
                      alt={product.name}
